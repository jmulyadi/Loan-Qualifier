...
def get_score(input):
    ...
    Ensure the score and explanation are fair and clearly tied to the data provided. Prioritize positive behaviors like consistent savings, timely repayments, and stable income, and penalize red flags like overdraft usage, late repayments, or high-risk patterns.
